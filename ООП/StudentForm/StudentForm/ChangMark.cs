...
{
    public partial class ChangMark : Form
    {
        public ChangMark()
        {
            InitializeComponent();
        ...
        private void ChangMark_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            if (comboBox1.GetItemText(comboBox1.SelectedItem) == Transit.student1.FirstName1 + " " + Transit.student1.Name1 + " " + Transit.student1.FatherName1)
            {
                ...
                {
                    int menu = 1;
                    Transit.student1.changeMark(menu, Convert.ToDouble(comboBox3.SelectedItem));
                ...
                {
                    MessageBox.Show("Невозможно изменить оценку - оценка не существует\nВнесите оценку в соответсвующем меню");
                }
                else if (comboBox2.GetItemText(comboBox2.SelectedItem) == "Математика" & Transit.student1.MarkMath != 0)
                {
                    ...
                    Transit.student1.changeMark(menu, Convert.ToDouble(comboBox3.SelectedItem));
                    MessageBox.Show("Оценка изменена");
                } else if (comboBox2.GetItemText(comboBox2.SelectedItem) == "Программирование" & Transit.student1.MarkMath == 0)
                {
                    MessageBox.Show("Невозможно изменить оценку - оценка не существует\nВнесите оценку в соответсвующем меню");
                }
            ...
            else if (comboBox1.GetItemText(comboBox1.SelectedItem) == Transit.student2.FirstName1 + " " + Transit.student2.Name1 + " " + Transit.student2.FatherName1)
            {
                ...
                {
                    int menu = 1;
                    Transit.student2.changeMark(menu, Convert.ToDouble(comboBox3.SelectedItem));
                    MessageBox.Show("Оценка изменена");
            ...
            else if (comboBox1.GetItemText(comboBox1.SelectedItem) == Transit.student3.FirstName1 + " " + Transit.student3.Name1 + " " + Transit.student3.FatherName1)
            {
                ...
                {
                    int menu = 1;
                    Transit.student3.changeMark(menu, Convert.ToDouble(comboBox3.SelectedItem));
                    MessageBox.Show("Оценка изменена");
        ...
        private void ChangMark_Load(object sender, EventArgs e)
        {
