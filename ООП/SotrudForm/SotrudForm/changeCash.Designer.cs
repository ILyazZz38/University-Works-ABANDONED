namespace SotrudForm
{
    partial class changeCash
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Изменить зарплату за месяц";
            // 
            // label2
            // 
            ...
            this.Name = "changeCash";
            this.Text = "changeCash";
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.ChangeCash_FormClosed);
            this.Load += new System.EventHandler(this.ChangeCash_Load);
